...
Three hundred thousand chips. It was an enormous commitment — a bet that the console would sell in volumes that justified a bulk purchase on a scale that most consumer electronics companies would find reckless. If the Mega Drive flopped, Sega would be sitting on a warehouse full of expensive processors with no use for them. But the gamble was also leverage: by committing to volume, Sato could demand a price that would have been impossible for a smaller order. Signetics agreed. Sato secured the 68000 at approximately one-tenth of the original quoted price.[^19]
...
[^19]: Sato secured the Motorola 68000 at approximately one-tenth of the original quoted price through the bulk purchase commitment. See SegaBits, "Sega's Hideki Sato Talks About Creating the Mega Drive to Beat Nintendo."
